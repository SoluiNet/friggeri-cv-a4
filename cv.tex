...
Country
~
\href{tel:+00001111111}{+0 (000) 111 1111}
\href{tel:+00001111112}{+0 (000) 111 1112}
~
...
\section{languages}
\begin{footnotesize} english \starsolid\starsolid\starsolid\starsolid\starsolid\\ % mother tongue
spanish \starsolid\starsolid\starsolid\starsolid\starempty\\ % business fluent
italian \starsolid\starsolid\starempty\starempty\starempty % conversation fluent
\end{footnotesize}
\section{programming}
\begin{footnotesize} JavaScript {\color{red} $\varheartsuit$}
\mbox{Python, C++, PHP\hspace{0.3cm}}
\mbox{CSS3 \& HTML5\hspace{0.3cm}}\end{footnotesize}
\end{aside}
